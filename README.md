...
To build the final jar and optimize the auctionapp application for production, run:
...
Then navigate to [http://localhost:8900](http://localhost:8900) in your browser.
